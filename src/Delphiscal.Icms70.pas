...
type
  ...
  public
    constructor Create(const AValorProduto, AValorFrete, AValorSeguro, ADespesasAcessorias, AValorDesconto, AAliquotaIcms, APercentualReducao, AAliquotaIcmsST, AMva: Currency; const APercentualReducaoST: Currency = 0; const AValorIpi: Currency = 0);
...
constructor TIcms70.Create(const AValorProduto, AValorFrete, AValorSeguro, ADespesasAcessorias, AValorDesconto, AAliquotaIcms, APercentualReducao, AAliquotaIcmsST, AMva: Currency; const APercentualReducaoST: Currency = 0; const AValorIpi: Currency = 0);
begin
